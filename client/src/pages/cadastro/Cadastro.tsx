...
import { CadastroRequest } from '../../endpoints/CadastroRequest';
...
export class Cadastro extends Component {
    ...
    render() {
        return <div style={style.loginBox}>
            ...
            <div style={style.row}>
                <Input label="Nome" type="name" onChange={e => { this.setState({ nome: e.target.value }) }} />
                <Input label="Sobrenome" type="lastname" onChange={e => { this.setState({ sobreNome: e.target.value }) }} />
            </div>
            <div style={style.row}>
                <Input label="Email" type="email" onChange={e => { this.setState({ email: e.target.value }) }} />
            </div>
            <div style={style.row}>
                <Input label="Senha" type="password" onChange={e => { this.setState({ senha1: e.target.value }) }} />
                <Input label="Confirmar senha" type="password" onChange={e => { this.setState({ senha2: e.target.value }) }} />
            </div>
            <div style={style.row}>
